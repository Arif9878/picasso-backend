...
type DayOff struct {
	...
	FilePath           string                 `json:"file_path,omitempty" bson:"file_path,omitempty" binding:"required"`
	FileURL            string                 `json:"file_url,omitempty" bson:"file_url,omitempty" binding:"required"`
